    ...
    try {
      ...
      if (json.data) {
        ...
        if (json.data.responsibilities)
          setValue("responsibilities", json.data.responsibilities.join("\n"));
        if (json.data.requirements)
          setValue("requirements", json.data.requirements.join("\n"));
        if (json.data.benefits)
          setValue("benefits", json.data.benefits.join("\n"));
    ...
    <div className="page-container">
      ...
      <div className="main-content">
        <TopBar
          ...
          subtitle="Create a job listing to find the best candidates"
        />
                  ...
                  {skills.length > 0 && (
                    <div className="flex flex-wrap gap-2 mt-3">
                      {skills.map((skill) => (
                        <span
                          key={skill}
                          className="flex items-center gap-1.5 badge-blue text-xs"
                        >
                          {skill}
                          <button
                            type="button"
